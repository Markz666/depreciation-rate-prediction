...
def train_and_predict(train, test):
    ...
    LR_pre = LogisticRegression(C=20, penalty='l2', solver='liblinear')
    SVM_pre = svm.SVC(C=15,kernel='rbf',gamma='auto')
    CART_pre = tree.DecisionTreeClassifier(criterion="gini", max_depth=20)
    ...
    SGD_pre = SGDClassifier(alpha=0.01,penalty='l2')
...
if __name__ == "__main__":
    ...
    for name in name_list:
        ...
        data = data[pd.notnull(data['Oprice'])]
